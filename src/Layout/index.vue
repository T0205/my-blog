<template>
  <div id="layoutView">
    ...
    <!-- 返回顶部的组件 -->
    <ToTop :scrollTop="scrollTop" :scrollHeight="scrollHeight" :clientHeight="clientHeight"></ToTop>
    ...
    <div id="paddingTop">
      <transition name="header-fade">
        <Header v-if="isShowHeader" :style="{ backgroundColor: headerBgColor, }"></Header>
      </transition>
    </div>
